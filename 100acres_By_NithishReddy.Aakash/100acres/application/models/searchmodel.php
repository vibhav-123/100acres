...
class Searchmodel extends CI_Model{
	...
	public function search_property($post,$offset=0,$limit=1){
		...
		$this->db->select('property.pid,property_type,city,address,bedrooms,expected_price,image_path_name,pp_area,Type_of_person,Purpose,UserTable.username,mobileno,description');
