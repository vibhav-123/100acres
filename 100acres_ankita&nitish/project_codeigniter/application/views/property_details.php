	...
	<body>
		...
		<div class="container_of_search">
			...
			<div class="drivingDirections">
				...
				<input type="text" style="width:600px;height:40px;border:none;box-shadow:0px 0px 3px grey;" id="source" placeholder="Enter starting point" >

			 	<button class="styled-button-submit" onclick="window.open('http://maps.google.com/?saddr='+document.getElementById('source').value+'&daddr='+<?php echo $lat ?>+','+<?php echo $lon ?>)" >Get Directions
			 	</button>
			</div>
