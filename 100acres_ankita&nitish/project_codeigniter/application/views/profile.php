...
<html>
	...
	<body>
        <div id="container">
			<div id="header">
			    <h1>100acres.com</h1>
				<a href="http://www.100acres.com/index.php/welcome/my_profile">Welcome <?php echo $name;?></a>
				<a href="http://www.100acres.com/index.php/welcome/logout">Logout</a>
				<a href="http://www.100acres.com/application/views/sell_property.php">Sell/Rent property</a>
				<a>1800 41 99099</a>
	        </div>	
			<div id="content">
