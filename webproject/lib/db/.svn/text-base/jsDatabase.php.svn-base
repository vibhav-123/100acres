...
abstract class jsDatabase {
   ...
   *
   * @throws <b>jsDatabaseException</b> If a connection could not be retrieved
   */
  ...
  /**
   * Retrieves a raw database resource associated with this jsDatabase implementation.
   *
   * @return mixed A database resource
   *
   * @throws <b>jsDatabaseException</b> If a resource could not be retrieved
   */
