...
<!-- CONTACT DIV STARTS -->
<!-- CONTACT DIV STARTS -->
<div style="background-color: #007dc1;opacity:0.8;height: 6%;width: 12.5%;position: absolute;left: 40%;top: 33%;box-shadow:0px 0px 5px 10px white;"></div>
<div style="text-align: center;color: #FACC2E;position: absolute;left: 40%;top: 30%"><h1>CONTACT</h1>
</div>
<div style="background-color: #007dc1;opacity:0.8;height: 30%;width: 55%;left:20%;position: absolute;top: 40%;box-shadow:0px 0px 5px 10px white;"></div>
</div>
<div style="left:20%;position: absolute;top: 40%;width: 55%">
	<table border="0" style="height: 50%;width: 100%">
		<tr>
			<td style="width: 50%;color: #FACC2E;"><h1>Ashraf Khan</h1></td>
			<td style="width: 50%;color: #FACC2E;" align="right"><h1>Dheeraj Goyal</h1></td>
		</tr>
		<tr>
			<td><h1>+919599587759</h1> </td>
			<td style="width: 50%" align="right"><h1>+919599926481</h1></td>
		</tr>
	</table>
</div>
