...
<link rel="stylesheet" type="text/css" href="<?php echo $css; ?>style_search.css">
...
<div style="position: absolute;height: 24%;width: 60%;opacity:.95;left:20%;top:45%;">

    <div style="height: 40px;border-top: solid black 2px;">
        <div  style="width:33.3333%;height:100%;float: left;text-align: center;">
            <font  class="myButton1" id="buy_button" style="width: 100%;height: 100%;background-color: #007dc1; color:black;  padding-left: 0;padding-right: 0;padding-bottom: 0;" onclick="showbuy();">
                BUY
            </font>
        </div>
        <div style="width:33.3333%;height:100%;float: left;text-align: center;">
            <font class="myButton1" id="rent_button" style="width: 100%;height: 100%;background-color: #ededed;padding-left: 0;padding-right: 0;padding-bottom: 0;" onclick="showrent()">
                RENT
            </font>
        </div>
        <div style="width:33.3333%;height:100%;float: left;text-align: center;">
            <font class="myButton1" id="pg_button" style="width: 100%;height: 100%;background-color: #ededed;padding-left: 0;padding-right: 0;padding-bottom: 0;" onclick="showpg()">
                PG/HOSTEL
            </font>
        </div>
    </div>
    ...
    <div style="width:100%;height: 60px;z-index: 2;position: absolute;">
        <div  style="width:20%;height:100%;background-color: #007dc1;float: left;text-align: center;">
        ...
        <div style="width:20%;height:100%;background-color: #007dc1;float: left;text-align: center;">
            <button class="myButton2"id="search_main" type="submit" style="height: 60%;width: 80%;position: relative;top: 9px ;">
                Search
            </button>
        </div>
    </div>

    <div id="buy" style="width: 100%;height: 60px;z-index: 1;position: absolute;top: 100px;display: none;">
        <div style="width:33.3333%;height:100%;background-color: #ededed;float: left;text-align: center ;padding-top: 6px">
            Price<br>
            <select  class="myButton3" style="width: 40%;" name="search_buy_min_price">
            ...
            &nbsp; &nbsp; &nbsp; &nbsp;
            <select class="myButton3" style="width: 40%" name="search_buy_max_price">
        ...
        <div id="buy_residential" style="width:16.66666%;height:100%;background-color: #ededed;float: left;text-align: center;padding-top: 6px">
 			BHK
          	<br>
            <select class="myButton3" style="width: 75%" name="search_buy_bhk">
        ...
        <div id="buy_commercial" style="width:16.66666%;height:100%;background-color: #ededed;float: left;text-align: center;padding-top: 6px;display: none;">
 			Washroom<br>
            <select class="myButton3" style="width: 75%" name="search_buy_washroom">
                <option selected="selected" value="any">Any</option>
                <option value="1" >1</option>
                <option value="2">2</option>
                <option value="3">3</option>
        ...
        <div style="width:16.66666%;height:100%;background-color: #ededed;float: left;text-align: center;padding-top: 6px;">
            Posted By<br>
            <select  class="myButton3" style="width: 75%" name="search_buy_person">
                <option selected="selected" value="any">Any</option>
        ...
        <div style="width:33.1%;height:100%;background-color: #ededed;float: left;text-align: center;padding-top: 6px">
            Built-up Area<br>
            <select class="myButton3" style="width: 45%" name="search_buy_area">
    ...
    <div id="rent" style="width: 100%;height: 60px;z-index: 1;position: absolute;top: 100px;display: none;">
        <div style="width:33.3333%;height:100%;background-color: #ededed;float: left;text-align: center ;padding-top: 6px">
            Rent<br>
            <select class="myButton3" style="width: 40%" name="search_rent_min_price">
                <option selected="selected" value="0">Min</option>
            ...
            &nbsp; &nbsp; &nbsp; &nbsp;
            <select class="myButton3" style="width: 40%" name="search_rent_max_price">
        ...
        <div id="rent_residential" style="width:16.66666%;height:100%;background-color: #ededed;float: left;text-align: center;padding-top: 6px">
 			BHK
          	<br>
            <select class="myButton3" style="width: 75%" name="search_rent_bhk">
                <option selected="selected" value="any">Any</option>
                <option value="1" >1</option>
                <option value="2">2</option>
                <option value="3">3</option>
        ...
        <div id="rent_commercial" style="width:16.66666%;height:100%;background-color: #ededed;float: left;text-align: center;padding-top: 6px;display: none;">
 			Washroom<br>
            <select class="myButton3" style="width: 75%" name="search_rent_washroom">
                <option selected="selected" value="any">Any</option>
                <option value="1" >1</option>
                <option value="2">2</option>
                <option value="3">3</option>
        ...
        <div style="width:16.66666%;height:100%;background-color: #ededed;float: left;text-align: center;padding-top: 6px;">
            Posted By<br>
            <select  class="myButton3" style="width: 75%" name="search_rent_person">
                <option selected="selected" value="any">Any</option>
                <option value="owner" >Owner</option>
                <option value="builder">Builder</option>
                <option value="broker">Broker</option>
        ...
        <div style="width:33.1%;height:100%;background-color: #ededed;float: left;text-align: center;padding-top: 6px">
        Built-up Area<br>
            <select class="myButton3" style="width: 45%" name="search_rent_area">
                <option selected="selected" value="0">Any</option>
                <option value="5">500-1000</option>
                <option value="10">1000-1500</option>
                <option value="15">1500-2000</option>
    ...
    <div id="pg" style="width: 100%;height: 60px;z-index: 1;position: absolute;top: 100px;display: none;">
        <div style="width:33.3333%;height:100%;background-color: #ededed;float: left;text-align: center ;;padding-top: 6px">
            Rent<br>
            <select class="myButton3" style="width: 40%" name="search_pg_min_price">
                <option selected="selected" value="0">Min</option>
                <option value="5000">5000</option>
                <option value="10000">10000</option>
                <option value="15000">15000</option>
            ...
            &nbsp; &nbsp; &nbsp; &nbsp;
            <select class="myButton3" style="width: 40%" name="search_pg_max_price">
                <option selected="selected" value="1000000">Max</option>
                <option value="5000">5000</option>
                <option value="10000">10000</option>
                <option value="15000">15000</option>
        ...
        <div style="width:33.3333%;height:100%;background-color: #ededed;float: left;text-align: center;padding-top: 6px">
 			Sharing&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Posted By<br>
            <select class="myButton3" style="width: 35%" name="search_pg_sharing">
                <option selected="selected" value="any">Any</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <select  class="myButton3" style="width: 35%" name="search_pg_person">
                <option selected="selected" value="any">Any</option>
                <option value="owner" >Owner</option>
                <option value="builder">Builder</option>
                <option value="broker">Broker</option>
        ...
        <div style="width:33.3333%;height:100%;background-color: #ededed;float: left;text-align: center;padding-top: 6px">
            Gender<br>
            <select class="myButton3" style="width: 45%" name="search_pg_gender">
                <option selected="selected" value="any">Any</option>
